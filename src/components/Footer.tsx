...
export default function Footer() {
  ...
  return (
    <footer
      id="footer"
      className="relative py-24 border-t border-border-dark overflow-hidden"
      ref={ref}
    >
      {/* Big background text */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none overflow-hidden">
        <span
          className="font-syne font-extrabold text-[clamp(4rem,18vw,16rem)] text-transparent leading-none"
          style={{ WebkitTextStroke: "1px rgba(255,77,46,0.06)" }}
        >
          juandaherrera
        </span>
      </div>
      ...
      <div className="section-container relative">
        ...
        >
          ...
          {/* Copyright */}
          <p className="font-figtree text-base text-muted/60">
            © {year}{" "}
            <a
